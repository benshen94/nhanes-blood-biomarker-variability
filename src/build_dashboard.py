...
<body>
  ...
  <script>
    ...
    const WATERFALL_AGE_BINS = [
      { label: '20-24', lo: 20, hi: 25 },
      { label: '25-29', lo: 25, hi: 30 },
      { label: '30-34', lo: 30, hi: 35 },
      ...
      { label: '65-69', lo: 65, hi: 70 },
      { label: '70-74', lo: 70, hi: 75 },
      { label: '75-79', lo: 75, hi: 80 },
      { label: '80-84', lo: 80, hi: 85 },
      { label: '85+', lo: 85, hi: 200 },
    ];
